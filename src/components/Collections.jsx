    ...
    <div className='  mt-[10%]'>
            ...
            <div className=' flex justify-center gap-8 mt-7'>
                {
                    buttonCard.map((elem, index) =>{
                        return <button  className=' zero pt-3 pb-3 pl-6  pr-6 bg-transparent border border-gray-600 rounded-md text-gray-400 '
        ...
        <div className=' grid grid-cols-2 mt-9 items-center justify-items-center'>
            <div className=' flex flex-col gap-4 w-[60%]'>
                ...
                <p className=' TT tracking-tight'>Buy Your NFTs, Trade until the bergins. Take on the role of the character you have, develop the role further. Find out how strong you are on the battlefield. Complete missions
solo and with other NFT  owners to gain more power. Finally rise to championship.</p>
